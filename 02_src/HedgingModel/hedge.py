...
def Put_Call_Parity_l(df, by_rank = 1):
    ...
    return pd.merge(df, parity_l[['time', 'code', 'profit_position']], on = ['time', 'code'], how = 'left')
...
def Put_Call_Parity_s(df, by_rank = 1):
    ...
    return pd.merge(df, parity_s[['time', 'code', 'profit_position']], on = ['time', 'code'], how = 'left')
...
def Bull_Call_Spread(df, by_rank = 1):
    ...
    return pd.merge(df, call_ls[['time', 'code', 'profit_position']], on = ['time', 'code'], how = 'left')
...
def Option_Position_Hold(df, quota = 0.5, limit = 1e6):
    ...
    df['current_position'] = exist_position['profit_position'].values
...
def Hedge_ATM(df, atm = 0.2, delta_tolerance = 0):
    ...
    df['hedge_position'] = exist_position['hedge_position'].values
